...
func main () () {
	...
	for {
		...
		for _, folder := range folders {
			...
			badRuns = slt.CheckStatus()
			
			////////////////////////
			// Log bad runs
			////////////////////////
			
			//FIXME log.Println("Check bad run list")
			// Load list
			
			// Check bad run and if necessary, quarantine files
			
			////////////////////////
			// Delete bad runs
			////////////////////////
			log.Println("Delete bad simulations:"/* and log them"*/)
			for _, file = range badRuns {
				fmt.Println(file)
			...
			// Continue good runs
			////////////////////////
			log.Println("Continue good runs")
